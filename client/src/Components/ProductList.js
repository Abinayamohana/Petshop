...
const ProductList = ({ apiEndpoint, title }) => {
  ...
  return (
    <Container className="mt-4">
      ...
      >
        <ToastBody>
          <img src={sparkle} alt="Success" width="40" height="40" />
          Product added successfully!
          <Button variant="light" className="ms-2" onClick={() => navigate('/cart')}>Go To Cart</Button>
        </ToastBody>
      </Toast>
    </Container>
  );
